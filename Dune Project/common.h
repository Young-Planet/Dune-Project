...
#define CURSOR_COLOR 240   // 커서 색상
#define CURSOR_MOVE_DISTANCE 3   // 방향키 더블클릭 시 이동 거리

#define KEY_SELECT ' '     // 스페이스바로 선택
#define KEY_CANCEL 27      // ESC 키
...
typedef struct {
	...
	bool isSelected;    // 선택 여부를 나타내는 필드 추가
} CURSOR;
...
void cursor_move(CURSOR* cursor, DIRECTION dir, int distance); // 커서 이동 함수
